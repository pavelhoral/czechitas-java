...
public class SpousteciTrida {
    ...
    public static void main(String[] args) {
        ...
        jmeno = "Kamil";
        jmeno = new String(new char[] { 'K', 'a', 'm', 'i', 'l' });
        mujVek = 36;
        mojeVyska = 1.80;
        ...
        int den;
        den = dneskaTedka.toLocalDate().getDayOfMonth();
        ...
        radek = nacitacZKlavesnice.nextLine();

        double mojeHmotnost;
        DoubleFormatter prevodnikCisel;
        prevodnikCisel = new DoubleFormatter("0.##");
        mojeHmotnost = prevodnikCisel.parse(radek);
        System.out.println(mojeHmotnost);
    }
